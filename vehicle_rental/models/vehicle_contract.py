...
class VehicleContract(models.Model):
    ...
    start_date_display_en = fields.Char(
        string="Pick-up Date",
        compute="_compute_english_datetime_display",
    )
    ...
    end_date_display_en = fields.Char(
    ...
    def _compute_english_datetime_display(self):
        for rec in self:
            rec.start_date_display_en = rec._format_datetime_en(rec.start_date)
            rec.end_date_display_en = rec._format_datetime_en(rec.end_date)
