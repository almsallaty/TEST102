...
class CarTestDrive(models.Model):
    ...
    def create(self, vals_list):
        ...
        for rec in records:
            ...
            desired_deposit_collected = bool(rec.deposit_invoice_id and rec.deposit_invoice_id.payment_state in ('paid', 'in_payment', 'partial'))
    ...
    def action_create_deposit_invoice(self):
        ...
        self.deposit_collected = move.payment_state in ('in_payment', 'paid', 'partial')
