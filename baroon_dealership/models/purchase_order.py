...
class PurchaseOrder(models.Model):
    ...
    def button_confirm(self):
        ...
        for order in self:
            ...
            if any(line._get_all_vins() for line in car_lines):
                order.action_create_cars_from_vins()
            if car_lines and order.shipment_status == 'draft':
                order.shipment_status = 'incoming'
            order.mapped('picking_ids')._prepare_dealership_incoming_serials()
        return res
    ...
    def action_create_cars_from_vins(self):
        ...
        self.mapped('picking_ids')._prepare_dealership_incoming_serials()
